...
<div class="component" in:opacity out:opacity on:outroend={after_leave}>
    <div class="all">
        <div id="top">
            <MyNavButton
                in_style="width: 80px; height: 30px"
                isChecked={$current_account === "Microsoft"}
                on:click={() => current_account.set("Microsoft")}
            >
                <svg
                    role="img"
            ...
            <MyNavButton
                in_style="width: 80px; height: 30px"
                isChecked={$current_account === "Offline"}
                on:click={() => current_account.set("Offline")}
            >
                <svg
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <MyNavButton
                in_style="width: 80px; height: 30px"
                isChecked={$current_account === "Thirdparty"}
                on:click={() => current_account.set("Thirdparty")}
            >
                <svg
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
