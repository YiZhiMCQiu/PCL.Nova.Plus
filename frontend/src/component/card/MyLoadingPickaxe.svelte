...
<div
    class="ala"
    style="{style_in}; --dark-color: {dark}; --font-color: {state
        ? '#ff1f1fcf'
        : '#1370F3cf'}; --is-infinite: {state
        ? '1'
        : 'infinite'}; --icon-hidden: {state ? '1' : '0'}"
>
    <svg
    ...
    >
        <!--镐子底下的线-->
        <path stroke-width="2" stroke-linecap="round" d="M5 66L29 66" />
        <!--镐子本体-->
        <path
