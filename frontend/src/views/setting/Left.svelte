...
>
    <MySidebarButton
        isChecked={$current_setting === "Launch"}
        in_style="margin-top: 8px"
        on:click={() => {
            current_setting.set("Launch");
        }}
    >
        <svg
    ...
    <MySidebarButton
        isChecked={$current_setting === "Personalization"}
        on:click={() => {
            current_setting.set("Personalization");
        }}
    >
        <svg
            role="img"
    ...
    <MySidebarButton
        isChecked={$current_setting === "Other"}
        on:click={() => {
            current_setting.set("Other");
        }}
    >
        <svg
            role="img"
    ...
    <MySidebarButton
        isChecked={$current_setting === "HomePage"}
        on:click={() => {
            current_setting.set("HomePage");
        }}
    >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            class="side-icon"
        >
            <path d="M13.5 1H.5m13 4H6m7.5 4H6m7.5 4H.5M2 5l2 2l-2 2" />
        </svg>
        <span>主页</span>
    </MySidebarButton>
</div>
