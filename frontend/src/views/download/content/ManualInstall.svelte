...
>
    <div id="left" style:background-color={dark}>
        <MySidebarButton
            isChecked={$current_manual === "Forge"}
            in_style="margin-top: 8px"
            on:click={() => current_manual.set("Forge")}
        >
            <svg
        ...
        <MySidebarButton
            isChecked={$current_manual === "Fabric"}
            on:click={() => current_manual.set("Fabric")}
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
        ...
        <MySidebarButton
            isChecked={$current_manual === "Quilt"}
            on:click={() => current_manual.set("Quilt")}
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            >
                <g>
                    ...
                    <path
                        d="M12 9v6m4 0v6m0-18v6M3 15h18M3 9h18M8 15v6M8 3v6"
                    />
                </g>
            </svg>
        ...
        <MySidebarButton
            isChecked={$current_manual === "NeoForge"}
            on:click={() => current_manual.set("NeoForge")}
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            >
                <g>
                    <path
                        d="M19.9 8.3C20.6 7 21 5.6 21 4c0-.6-.4-1-1-1c-2.3 0-4.3.8-5.9 2.2a15 15 0 0 0-4.2 0A8.78 8.78 0 0 0 4 3c-.6 0-1 .4-1 1c0 1.6.4 3 1.1 4.3c-.6.7-1.1 1.4-1.4 2.2C4 13 11 16 12 16s8-3 9.3-5.5c-.3-.8-.8-1.5-1.4-2.2M9 9v.5m4 3.5h-2m1 3v-3m3-4v.5"
                    />
                    <path
                        d="M6.3 20.5A6.87 6.87 0 0 0 9 15H2.2c.8 4 4.9 7 9.8 7c5.5 0 10-3.8 10-8.5c0-1.1-.2-2.1-.7-3"
                    />
                </g>
            </svg>
        ...
        <MySidebarButton
            isChecked={$current_manual === "Optifine"}
            on:click={() => current_manual.set("Optifine")}
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
            ...
            >
                <g>
                    ...
                    <path
                        d="M21 7.353v9.294a.6.6 0 0 1-.309.525l-8.4 4.666a.6.6 0 0 1-.582 0l-8.4-4.666A.6.6 0 0 1 3 16.647V7.353a.6.6 0 0 1 .309-.524l8.4-4.667a.6.6 0 0 1 .582 0l8.4 4.667a.6.6 0 0 1 .309.524M3.528 7.294L8.4 10m12.1-2.722L15.6 10M12 21v-5"
                    />
                </g>
            </svg>
        ...
        <MySidebarButton
            isChecked={$current_manual === "LiteLoader"}
            on:click={() => current_manual.set("LiteLoader")}
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
